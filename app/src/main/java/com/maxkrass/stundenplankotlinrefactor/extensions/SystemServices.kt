...
/**
 * Max made this for StundenplanKotlinRefactor on 17.09.2017.
 */
...
inline val Context.wifiManager get() = applicationContext.getSystemService(WIFI_SERVICE) as WifiManager
