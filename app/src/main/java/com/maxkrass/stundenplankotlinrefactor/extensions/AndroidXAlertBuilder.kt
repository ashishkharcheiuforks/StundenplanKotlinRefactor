...
val AndroidX: AlertBuilderFactory<AlertDialog> = ::AndroidXAlertBuilder

internal class AndroidXAlertBuilder(override val ctx: Context) : AlertBuilder<AlertDialog> {
